    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        submitBtn.setOnClickListener(v -> {
            if (isFormValid()) {
                ...
                String name = subscriptionNameEditText.getText().toString().trim();
                double price = Double.parseDouble(subscriptionPriceEditText.getText().toString().trim());
                ...
                SubscriptionsFragment.Subscription newSub = new SubscriptionsFragment.Subscription(
                        name, price, category, status, billingCycle);

                Bundle bundle = new Bundle();
                bundle.putSerializable("subscription", newSub);

                // Navigate back with the subscription object as argument
                Navigation.findNavController(view).navigate(R.id.action_addSubscriptions_to_subscriptionsFragment, bundle);
            } else {
