...
public class SubscriptionDetailsPaidFragment extends Fragment {

    private Dialog dialog;
    private Button delete_permanently_btn, delete_subs_cancel_btn;
    private FirebaseFirestore db;
    private String subscriptionId;

    public SubscriptionDetailsPaidFragment() {
        super(R.layout.fragment_subscription_details_paid);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_subscription_details_paid, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        ImageButton backButton = view.findViewById(R.id.sub_detail_paid_backBtn);
        backButton.setOnClickListener(v -> NavHostFragment.findNavController(this).navigateUp());

        Button deleteSubs = view.findViewById(R.id.delete_subs_btn);
        deleteSubs.setOnClickListener(v -> showDeleteSubsDialog());

        Button editInfoBtn = view.findViewById(R.id.paidsubs_details_edit_info_btn);
        editInfoBtn.setOnClickListener(v -> {
            if (args != null) {
                NavHostFragment.findNavController(this)
                        .navigate(R.id.action_subscriptionDetailsPaid_to_editSubscriptionFragment, args);
            }
        });
    }
    ...
    private void populateViews(View view, Bundle args) {
        // TextViews
        TextView nameTv = view.findViewById(R.id.paidsubs_details_name);
        TextView subsIdTv = view.findViewById(R.id.paidsubs_details_subsID);
        TextView noteTv = view.findViewById(R.id.paidsubs_details_note);
        TextView startDateTv = view.findViewById(R.id.paidsubs_details_startdate);
        TextView nextBillDateTv = view.findViewById(R.id.paidsubs_details_nextbilldate);
        TextView billingCycleTv = view.findViewById(R.id.paidsubs_details_billingcycle);
        TextView priceTv = view.findViewById(R.id.paidsubs_details_price);
        TextView paymentMethodTv = view.findViewById(R.id.paidsubs_details_paymentmethod);
        TextView lastPaidDueTv = view.findViewById(R.id.paidsubs_details_lastpaiddue);
        ...
        // Set category image
        ImageView categoryIv = view.findViewById(R.id.paid_category_name);
        ...
        // Set status image
        ImageView statusIv = view.findViewById(R.id.paid_status);
    ...
    private void deleteSubscription() {
        ...
        db.collection("subscriptions")
                ...
                .addOnSuccessListener(aVoid -> {
                    ...
                    NavHostFragment.findNavController(this)
                            .navigate(R.id.action_subscriptionDetailsPaid_to_subscriptionsFragment);
                })
